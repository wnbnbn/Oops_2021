...
这把 key 历史上公开，仅用于测试。未改应用包名，versionCode 5 / versionName 0.5.0。
...
- Feed 仅视频；点赞/收藏保持轻加权，避免相邻同视频/同内容组。保留原 v0.5 首帧 poster 防闪时序。
...
- 防闪修改仍需 OnePlus Ace 6 / ColorOS 16 真机验收，编译成功不能证明画面已修复。
